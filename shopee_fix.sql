...
--Cap nhat san pham
create proc sp_CapNhatSanPham(@masp nvarchar(20), @mota nvarchar(20), 
@cd float, @cr float, @cc float, @giavanchuyen float, @dathang bit,
@tinhtrang nvarchar(50), @ngaychuanbi int)
as
begin
	update MATHANG set MOTASANPHAM=@mota, CHIEUCAO=@cc, CHIEUDAI=@cd, CHIEURONG=@cr, 
	GIAVANCHUYENDUKIEN=@giavanchuyen, DATHANGTRUOC =@dathang, TINHTRANG=@tinhtrang, SONGAYCANCHUANBI=@ngaychuanbi
